...
public abstract class RequirementInjectBoolean extends RequirementInject {
	...
	public boolean onRequirementRequest(Reward reward, AdvancedCoreUser user, ConfigurationSection data,
		...
		if (data.isBoolean(getPath()) || (isAlwaysForce() && data.contains(getPath())) || isAlwaysForceNoData()) {
	...
	public abstract boolean onRequirementsRequest(Reward reward, AdvancedCoreUser user, boolean num,
			RewardOptions rewardOptions);
